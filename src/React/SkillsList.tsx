...
const SkillsList = () => {
  ...
  const skills = {
    'Web Development': [
      'Fullstack web apps with Next.js and Laravel',
      'Responsive UI with React & Tailwind CSS',
      'RESTful API integration',
      'Authentication systems (JWT, session)',
    ],
    'Mobile Development': [
      'Progressive Web Apps (PWAs)',
      'Mobile-first responsive design',
      'React Native (basic proficiency)',
    ],
    'UI/UX Design & Prototyping': [
      'UI design with Figma and Canva',
      'Wireframing and component-based layout',
      'User flow mapping and UX improvements',
